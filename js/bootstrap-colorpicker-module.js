...
.directive('colorpicker', ['$window', '$document', '$compile', '$rootScope', 'Color', 'Slider', 'Helper', 'Swatches', function ($window, $document, $compile, $rootScope, Color, Slider, Helper, Swatches) {
  ...
  return {
    ...
    link: function ($scope, elem, attrs, ngModel) {
      ...
      stripesCheckBox = !inline ? '<input class="experimental-checkbox left" type="checkbox" ng-click="toggleStripes()" id="stripes-checkbox" name="stripes-checkbox"> <label class="inline-block left ml1" for="stripes-checkbox">STRIPES</label>' : '',
